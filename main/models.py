...
class Societe(models.Model):
    ...
    code_postal = models.CharField(max_length=60, null=True)
...
class User(AbstractBaseUser):
    ...
    societe = models.ForeignKey(
        Societe, on_delete=models.CASCADE, null=True, blank=True)
...
class Place(models.Model):
    ...
    ville = models.CharField(max_length=60, null=True)
    code_postal = models.CharField(max_length=65, null=True)
    pays = models.CharField(max_length=60, null=True)
    ...
    ancienne_ville = models.CharField(max_length=60, null=True)
    ancienne_code_postal = models.CharField(max_length=65, null=True)
    ancienne_pays = models.CharField(max_length=60, null=True)
...
class Emploi(models.Model):
    ...
    ancien_ville = models.CharField(max_length=60, null=True)
    ancien_code_postal = models.CharField(max_length=65, null=True)
    ancien_pays = models.CharField(max_length=60, null=True)
...
class Endettement(models.Model):
    phone_emploi = models.CharField(max_length=65)
    nom_responsable = models.CharField(max_length=60)
...
class CompteEndettement(models.Model):
    ...
    type_compte = models.CharField(max_length=60)
    compte = models.BooleanField(default=False)
    nom_compte = models.CharField(max_length=60, null=True)
...
class Cosignataire(models.Model):
    ...
    ville_naissance = models.CharField(max_length=60, null=True, blank=True)
    pays_naissance = models.CharField(max_length=60, null=True, blank=True)
    type_piece_id = models.CharField(max_length=60, null=True, blank=True)
    numero_piece_id = models.CharField(max_length=60, null=True, blank=True)
...
class Appointment(models.Model):
    ...
    num_client = models.CharField(max_length=60)
    ...
    societe = models.ForeignKey(
        Societe, on_delete=models.PROTECT, null=True, blank=True)
...
class Client(models.Model):
    ...
    parents = models.BooleanField(default=False)
    how_connu = models.TextField()
    statut = models.CharField(max_length=60, default="P1")
...
class Facture(models.Model):
    ...
    User_editeur = models.ForeignKey(
...
class Paiement(models.Model):
    ...
    num_transaction = models.CharField(max_length=60)
...
class Penalite(models.Model):
    ...
    User_encaisseur = models.CharField(max_length=60)
...
class Credit(models.Model):
    ...
    societe = models.ForeignKey(
        Societe, on_delete=models.CASCADE, default=None)
...
class ClientAnnotationContenu(models.Model):
    client_annotation = models.ForeignKey(
        ClientAnnotation, on_delete=models.CASCADE)
    date_ap = models.DateTimeField()
    date = models.DateTimeField(auto_now_add=True)
...
class ClientAnnotationContenuMessage(models.Model):
    client_annotation_contenu = models.ForeignKey(
        ClientAnnotationContenu, on_delete=models.CASCADE)
    Message = models.TextField()
    date_ap = models.DateTimeField()
    date = models.DateTimeField(auto_now_add=True)
...
class Dadsr(models.Model):
    ...
    num_courrier = models.CharField(max_length=60)
